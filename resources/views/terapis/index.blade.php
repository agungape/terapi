...
<div class="space-y-8 animate-in fade-in duration-500" 
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full md:w-auto">
            <form action="{{ route('terapis.index') }}" method="GET" class="relative group flex-1 sm:flex-none">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari Nama / NIB..." 
                       class="bg-white border border-slate-200 rounded-xl pl-11 pr-4 py-2.5 text-xs font-bold focus:ring-4 focus:ring-red-50 focus:border-red-200 outline-none w-full sm:w-64 transition-all shadow-sm">
            </form>

            @can('create terapis')
            <button @click="openCreateModal()" class="bg-red-500 hover:bg-red-600 text-white py-2.5 px-6 rounded-xl text-xs font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all shadow-lg shadow-red-200">
