...
@section('title', 'Hasil Observasi Perilaku')
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="space-y-1">
            <div class="flex items-center gap-2 text-xs font-bold text-slate-400 uppercase tracking-widest">
                ...
                <i data-lucide="chevron-right" class="w-3 h-3"></i>
                <span class="text-slate-600">Hasil Perilaku & Emosional</span>
            </div>
            <h2 class="text-2xl font-black text-slate-800 uppercase italic tracking-tight">Evaluasi Masalah Perilaku</h2>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-4 space-y-6">
            <div class="card-premium p-8 bg-white text-center flex flex-col items-center">
                ...
                <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1 italic">Profil Psikologis Pasien</p>
                ...
                <div class="w-full grid grid-cols-2 gap-4 mt-8">
                    ...
                    <div class="p-4 bg-emerald-50 rounded-2xl border border-emerald-100">
                        <p class="text-[9px] font-black text-emerald-400 uppercase mb-1">Instrumen</p>
                        <p class="text-xs font-black text-emerald-600 uppercase italic">KMPE</p>
                    </div>
                </div>
            </div>

            <div class="card-premium p-8 bg-slate-900 text-white relative overflow-hidden h-full flex flex-col justify-center">
                <i data-lucide="brain" class="w-32 h-32 absolute -right-4 -bottom-4 text-white/5"></i>
                <h4 class="text-xs font-black uppercase tracking-widest mb-4 italic">Metode KMPE</h4>
                <p class="text-[11px] text-slate-400 font-medium leading-relaxed">
                    Kuesioner Masalah Perilaku dan Emosional (KMPE) bertujuan mendeteksi dini penyimpangan mental emosional pada anak prasekolah.
                </p>
            </div>
        </div>
            ...
            <div class="card-premium bg-white overflow-hidden shadow-xl shadow-slate-200/50">
                <div class="px-8 py-6 bg-emerald-600 text-white flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h4 class="text-xs font-black uppercase tracking-widest mb-0.5">HASIL KUESIONER MASALAH PERILAKU DAN EMOSIONAL</h4>
                            <p class="text-[9px] font-bold text-white/70 uppercase">Evaluasi Respon Mental Emosional</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-8 bg-slate-50 border-t border-slate-100">
                    <div class="flex items-center gap-3">
                        ...
                        <span class="text-[9px] font-black text-slate-400 uppercase tracking-widest italic">Pemeriksaan Berkala Direkomendasikan Setiap 6 Bulan</span>
                    </div>
                </div>
            </div>
        </div>
