<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="text-primary"><i class="fas fa-clipboard-check mr-2"></i>Edit Assessment Psikologis</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="fas fa-home"></i> Home</a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{ route('assessment.index') }}">Assessment</a></li>
        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-file-medical mr-2"></i>Edit Formulir Pemeriksaan Psikologis
                    </h3>
                </div>
                                            ...
                                            <div class="card-body">
                                                            ...
                                                            <select
                                                                ...
                                                                @foreach ($anaks as $anak)
                                                                    <option value="{{ $anak->id }}"
                                                                        {{ $assessment->anak_id == $anak->id ? 'selected' : '' }}>
                                                                        {{ $anak->nama }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            @if ($roles->contains('psikolog'))
                                                                <input type="hidden" name="psikolog_id"
                                                                    value="{{ $assessment->psikolog_id }}">
                                                                <input type="text" class="form-control"
                                                                    value="{{ $assessment->psikolog->nama }}" readonly>
                                                            @else
                                                                <select
                                                                    ...
                                                                    @foreach ($psikologs as $psikolog)
                                                                        <option value="{{ $psikolog->id }}"
                                                                            {{ $assessment->psikolog_id == $psikolog->id ? 'selected' : '' }}>
                                                                            {{ $psikolog->nama }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control @error('tujuan_pemeriksaan') is-invalid @enderror" id="tujuan_pemeriksaan"
                                                        name="tujuan_pemeriksaan" rows="2" required>{{ old('tujuan_pemeriksaan', $assessment->tujuan_pemeriksaan) }}</textarea>
                                            ...
                                            <div class="card-body">
                                                        ...
                                                        @foreach ($assessment->observasi_awal as $index => $perilaku)
                                                            <div class="mb-3 position-relative">
                                                                <input type="text"
                                                                    ...
                                                                    name="perilaku[]"
                                                                    value="{{ old('perilaku.' . $index, $perilaku) }}"
                                                                    required>
                                                                <button
                                                                    class="btn btn-sm btn-outline-danger btn-remove position-absolute"
                                                                    style="right: 5px; top: 5px;" type="button"
                                                                    {{ count($assessment->observasi_awal) <= 1 ? 'disabled' : '' }}>
                                                                    <i class="fas fa-times"></i>
                                                                </button>
                                                            </div>
                                                        @endforeach
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control @error('kesimpulan_observasi') is-invalid @enderror" id="kesimpulan_observasi"
                                                        name="kesimpulan_observasi" rows="3" required>{{ old('kesimpulan_observasi', $assessment->kesimpulan_observasi) }}</textarea>
                                            ...
                                            <div class="card-body">
                                                        ...
                                                        @foreach ($assessment->hasil_pemeriksaan as $index => $hasil)
                                                            <div class="mb-3 position-relative">
                                                                <textarea class="form-control input-hasil-pemeriksaan @error('hasil_pemeriksaan') is-invalid @enderror"
                                                                    name="hasil_pemeriksaan[]" rows="2" required>{{ old('hasil_pemeriksaan.' . $index, $hasil) }}</textarea>
                                                                <button
                                                                    class="btn btn-sm btn-outline-danger btn-remove-hasil position-absolute"
                                                                    style="right: 5px; top: 5px;" type="button"
                                                                    {{ count($assessment->hasil_pemeriksaan) <= 1 ? 'disabled' : '' }}>
                                                                    <i class="fas fa-times"></i>
                                                                </button>
                                                            </div>
                                                        @endforeach
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control @error('diagnosa') is-invalid @enderror" id="diagnosa" name="diagnosa" rows="4"
                                                        required>{{ old('diagnosa', $assessment->diagnosa) }}</textarea>
                                                    <small class="form-text text-muted">
                                            ...
                                            <div class="card-body">
                                                        ...
                                                        @foreach ($assessment->rekomendasi_orangtua as $index => $rekomendasi)
                                                            <div class="mb-3 position-relative">
                                                                <textarea class="form-control input-rekomendasi @error('rekomendasi_orangtua') is-invalid @enderror"
                                                                    name="rekomendasi_orangtua[]" rows="2" required>{{ old('rekomendasi_orangtua.' . $index, $rekomendasi) }}</textarea>
                                                                <button
                                                                    class="btn btn-sm btn-outline-danger btn-remove-rekomendasi position-absolute"
                                                                    style="right: 5px; top: 5px;" type="button"
                                                                    {{ count($assessment->rekomendasi_orangtua) <= 1 ? 'disabled' : '' }}>
                                                                    <i class="fas fa-times"></i>
                                                                </button>
                                                            </div>
                                                        @endforeach
                                                        ...
                                                        @foreach ($assessment->rekomendasi_terapi as $index => $rekomendasi)
                                                            <div class="mb-3 position-relative">
                                                                <textarea class="form-control input-rekomendasi @error('rekomendasi_terapi') is-invalid @enderror"
                                                                    name="rekomendasi_terapi[]" rows="2" required>{{ old('rekomendasi_terapi.' . $index, $rekomendasi) }}</textarea>
                                                                <button
                                                                    class="btn btn-sm btn-outline-danger btn-remove-rekomendasi position-absolute"
                                                                    style="right: 5px; top: 5px;" type="button"
                                                                    {{ count($assessment->rekomendasi_terapi) <= 1 ? 'disabled' : '' }}>
                                                                    <i class="fas fa-times"></i>
                                                                </button>
                                                            </div>
                                                        @endforeach
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control @error('catatan_tambahan') is-invalid @enderror" id="catatan_tambahan"
                                                        name="catatan_tambahan" rows="3">{{ old('catatan_tambahan', $assessment->catatan_tambahan) }}</textarea>
                                        ...
                                        <div class="card shadow-sm">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="persetujuan_ya"
                                                            ...
                                                            value="1"
                                                            {{ old('persetujuan_psikolog', $assessment->persetujuan_psikolog) ? 'checked' : '' }}
                                                            required>
                                                ...
                                                <div class="form-group" id="alasan-tidak-setuju-group"
                                                    style="{{ !old('persetujuan_psikolog', $assessment->persetujuan_psikolog) ? '' : 'display: none;' }}">
                                                    ...
                                                    <textarea class="form-control @error('alasan_tidak_setuju') is-invalid @enderror" id="alasan_tidak_setuju"
                                                        name="alasan_tidak_setuju" rows="3">{{ old('alasan_tidak_setuju', $assessment->alasan_tidak_setuju) }}</textarea>
