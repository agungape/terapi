...
@section('content')
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
        <a href="#" class="navbar-brand">
            <img src="{{ asset('assets') }}/images/bsc-frontend.png" alt="logo" class="m-0" />
            {{-- <h1 class="m-0 text-primary"><i class="fa fa-book-reader me-3"></i>Brig</h1> --}}
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <a href="/login" class="btn btn-info rounded-pill px-3 d-none d-lg-block">Login<i
                        ...
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                ...
                                <p class="fs-5 fw-medium text-white mb-4 pb-2">Vero elitr justo clita lorem. Ipsum
                                    ...
                                    rebum sea elitr.</p>
                                <a href=""
                                    class="btn btn-warning rounded-pill py-sm-3 px-sm-5 me-3 animated slideInLeft">Learn
                                    More</a>
                                <a href=""
                                    class="btn btn-primary rounded-pill py-sm-3 px-sm-5 animated slideInRight">Our
                                    Classes</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center">
                                <img class="rounded-circle flex-shrink-0"
                                    src="{{ asset('assets') }}/frontend/img/user.jpg" alt=""
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <img class="img-fluid w-75 rounded-circle bg-light p-3"
                                src="{{ asset('assets') }}/frontend/img/about-1.jpg" alt="">
                        </div>
                        <div class="col-6 text-start" style="margin-top: -150px;">
                            <img class="img-fluid w-100 rounded-circle bg-light p-3"
                                src="{{ asset('assets') }}/frontend/img/about-2.jpg" alt="">
                        </div>
                        <div class="col-6 text-end" style="margin-top: -150px;">
                            <img class="img-fluid w-100 rounded-circle bg-light p-3"
                                src="{{ asset('assets') }}/frontend/img/about-3.jpg" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100 rounded"
                                src="{{ asset('assets') }}/frontend/img/call-to-action.jpg" style="object-fit: cover;">
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="classes-item">
                        <div class="bg-light rounded-circle w-75 mx-auto p-3">
                            <img class="img-fluid rounded-circle" src="{{ asset('assets') }}/frontend/img/classes-1.jpg"
                                alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="classes-item">
                        <div class="bg-light rounded-circle w-75 mx-auto p-3">
                            <img class="img-fluid rounded-circle" src="{{ asset('assets') }}/frontend/img/classes-2.jpg"
                                alt="">
                        </div>
                        <div class="bg-light rounded p-4 pt-5 mt-n5">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="classes-item">
                        <div class="bg-light rounded-circle w-75 mx-auto p-3">
                            <img class="img-fluid rounded-circle" src="{{ asset('assets') }}/frontend/img/classes-3.jpg"
                                alt="">
                        </div>
                        <div class="bg-light rounded p-4 pt-5 mt-n5">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="classes-item">
                        <div class="bg-light rounded-circle w-75 mx-auto p-3">
                            <img class="img-fluid rounded-circle" src="{{ asset('assets') }}/frontend/img/classes-4.jpg"
                                alt="">
                        </div>
                        <div class="bg-light rounded p-4 pt-5 mt-n5">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="classes-item">
                        <div class="bg-light rounded-circle w-75 mx-auto p-3">
                            <img class="img-fluid rounded-circle" src="{{ asset('assets') }}/frontend/img/classes-5.jpg"
                                alt="">
                        </div>
                        <div class="bg-light rounded p-4 pt-5 mt-n5">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="classes-item">
                        <div class="bg-light rounded-circle w-75 mx-auto p-3">
                            <img class="img-fluid rounded-circle" src="{{ asset('assets') }}/frontend/img/classes-6.jpg"
                                alt="">
                        </div>
                        <div class="bg-light rounded p-4 pt-5 mt-n5">
            ...
            <div class="bg-light rounded">
                <div class="row g-0">
                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100 rounded"
                                src="{{ asset('assets') }}/frontend/img/appointment.jpg" style="object-fit: cover;">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item position-relative">
                            <img class="img-fluid rounded-circle w-75"
                                src="{{ asset('assets') }}/frontend/img/team-1.jpg" alt="">
                            <div class="team-text">
                                <h3>{{ $t->nama }}</h3>
                                <p>{{ $t->alamat }}</p>
                                <div class="d-flex align-items-center">
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <div class="testimonial-item bg-light rounded p-5">
                    ...
                    <div class="d-flex align-items-center bg-white me-n5" style="border-radius: 50px 0 0 50px;">
                        <img class="img-fluid flex-shrink-0 rounded-circle"
                            src="{{ asset('assets') }}/frontend/img/testimonial-1.jpg"
                ...
                <div class="testimonial-item bg-light rounded p-5">
                    ...
                    <div class="d-flex align-items-center bg-white me-n5" style="border-radius: 50px 0 0 50px;">
                        <img class="img-fluid flex-shrink-0 rounded-circle"
                            src="{{ asset('assets') }}/frontend/img/testimonial-2.jpg"
                            style="width: 90px; height: 90px;">
                        <div class="ps-3">
                            <h3 class="mb-1">Client Name</h3>
                            <span>Profession</span>
                ...
                <div class="testimonial-item bg-light rounded p-5">
                    ...
                    <div class="d-flex align-items-center bg-white me-n5" style="border-radius: 50px 0 0 50px;">
                        <img class="img-fluid flex-shrink-0 rounded-circle"
                            src="{{ asset('assets') }}/frontend/img/testimonial-3.jpg"
                            style="width: 90px; height: 90px;">
                        <div class="ps-3">
                            <h3 class="mb-1">Client Name</h3>
                            <span>Profession</span>
                    ...
                    <div class="row g-2 pt-2">
                        <div class="col-4">
                            <img class="img-fluid rounded bg-light p-1"
                                src="{{ asset('assets') }}/frontend/img/classes-1.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid rounded bg-light p-1"
                                src="{{ asset('assets') }}/frontend/img/classes-2.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid rounded bg-light p-1"
                                src="{{ asset('assets') }}/frontend/img/classes-3.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid rounded bg-light p-1"
                                src="{{ asset('assets') }}/frontend/img/classes-4.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid rounded bg-light p-1"
                                src="{{ asset('assets') }}/frontend/img/classes-5.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid rounded bg-light p-1"
                                src="{{ asset('assets') }}/frontend/img/classes-6.jpg" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
