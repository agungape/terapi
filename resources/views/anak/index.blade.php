...
<div class="space-y-8 animate-in fade-in duration-500"
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full md:w-auto">
            <form action="{{ route('anak.index') }}" method="GET" class="relative group flex-1 sm:flex-none">
            ...
            @can('create anak')
            <a href="{{ route('anak.create') }}" class="bg-red-500 hover:bg-red-600 text-white py-2.5 px-6 rounded-xl text-xs font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all shadow-lg shadow-red-200">
