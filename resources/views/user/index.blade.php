                ...
                <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" id="validationCustom04" name="role">
                ...
                <form id="editUserForm" action="{{ route('user.update', ':id') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row mb-3">
                            <label for="validationCustom04" class="col-sm-4 col-form-label">{{ __('Level') }}</label>
                            <div class="col-sm-8">
                                <select class="form-control" id="editRole" name="role_edit">
                                    <option selected disabled value="">Pilih...</option>
                                    @foreach ($role as $value => $label)
                                        <option value="{{ $value }}"
                                            {{ $value == old('role') ? 'selected' : '' }}>
...
@section('scripts')
    <script>
        ...
        $('#editModal').on('show.bs.modal', function(event) {
            ...
            // Update action form
            var actionUrl = "{{ route('user.update', ':id') }}".replace(':id', id);
