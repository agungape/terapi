                        ...
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-11">
                                        <ul class="nav nav-pills">
                                            <li class="nav-item"><a class="nav-link active" href="#pendengaran"
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    {{-- observasi autis --}}
                                    <div class="active tab-pane" id="pendengaran">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="card shadow-sm">
                                                    <div class="card-header bg-success text-white text-center">
                                                        <h6 class="mb-0">HASIL INSTRUMEN PEMERIKSAAN PENYIMPANGAN
                                                            PENDENGARAN</h6>
                                                    </div>
                                                    <div class="card-body">
