                        ...
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-11">
                                        <ul class="nav nav-pills">
                                            <li class="nav-item"><a class="nav-link active" href="#perilaku"
                            ...
                            <div class="card-body">
                                <div class="tab-content">
                                    ...
                                    <div class="active tab-pane" id="perilaku">
                                        {{-- DAFTAR PERTANYAAN --}}
                                        <div class="row justify-content-center">
                                            <div class="col-lg-10">
                                                <div class="card shadow-sm">
                                                    <div class="card-header bg-success text-white text-center">
                                                        <h6 class="mb-0">HASIL INSTRUMEN KUESIONER MASALAH PERILAKU DAN
                                                            EMOSIONAL</h6>
                                                    </div>
                                                    <div class="card-body">
                                                                    ...
                                                                    @foreach ($qrperilaku as $index => $q)
                                                                        <tr>
                                                                            ...
                                                                            <td class="align-middle">
                                                                                {{ $q->question_perilaku->question_text }}
                                                                            </td>
