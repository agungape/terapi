            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label for="exampleInputMobile" class="col-sm-4 col-form-label">Jenis Terapi</label>
                            <div class="col-sm-8">
                                <select class="form-control @error('tarif_id') is-invalid @enderror select2"
                                    style="width:100%" name="tarif_id" id="tarif_id">
                                    @forelse ($tarif as $t)
