...
<head>
    ...
    <title>Hasil Scan Barcode Observasi</title>
...
<body>
    <div class="container">
        ...
        <div class="header">
            <h1>HASIL SCAN OBSERVASI ANAK</h1>
            <p class="subtitle">Data hasil observasi perkembangan anak</p>
        </div>
        ...
        <div class="signature">
            <h3>Verifikasi Observasi</h3>
            <img src="{{ asset('assets') }}/images/signature.png" alt="Tanda Tangan" class="signature-img">
