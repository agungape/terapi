                    ...
                    <div class="bs-stepper-content">
                        ...
                        <div id="logins-part" class="content" role="tabpanel" aria-labelledby="logins-part-trigger">
                            <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text"
                                                ...
                                                autofocus value="{{ old('nama') ?? ($anak->nama ?? '') }}"
                                            ...
                                            <div class="form-group row">
                                                <div class="form-group clearfix">
                                                    <div class="col-sm-5 icheck-primary d-inline">
                                                        <input type="radio" name="jenis_kelamin" id="radioPrimary1"
                                                            value="L"
                                                    ...
                                                    <div class="icheck-primary d-inline">
                                                        <input type="radio" name="jenis_kelamin" id="radioPrimary2"
                                                            value="P"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Anak
                                            ke</label>
                                        <div class="col-sm-9">
                                            <div class="form-group row">
                                                <div class="col-sm-4">
                        ...
                        <div id="information-part" class="content" role="tabpanel"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Suku
                                            Ibu</label>
                                        <div class="col-sm-9">
