...
@section('title', 'Upload Hasil Assessment')
...
<div class="space-y-8 animate-in fade-in duration-500">
    ...
    <div class="flex items-center justify-between">
        <div class="flex items-center gap-2 text-xs font-bold text-slate-400 uppercase tracking-widest">
            ...
            <i data-lucide="chevron-right" class="w-3 h-3"></i>
            <span class="text-slate-600">Upload Hasil</span>
        </div>
    ...
    <div class="card-premium p-8 relative overflow-hidden">
        ...
        <div class="relative z-10">
            <div class="flex items-center gap-4 mb-2">
                ...
                <div>
                    <h3 class="text-lg font-extrabold text-slate-800 tracking-tight">Formulir Assessment Psikologis</h3>
                    <p class="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Lengkapi seluruh data hasil pemeriksaan anak di bawah ini</p>
                </div>
            </div>
        </div>
    </div>
