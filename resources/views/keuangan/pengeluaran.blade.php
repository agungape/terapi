            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors group">
                        ...
                        <td class="px-6 py-4">
                            <span class="text-xs font-black text-slate-700 italic uppercase">{{ $pengeluaran->tanggal_formatted }}</span>
                        </td>
                        <td class="px-6 py-4">
                                ...
                                @can('delete pengeluaran')
                                    ...
                                    <form action="{{ route('pengeluaran.destroy', $pengeluaran->id) }}" method="POST" class="inline">
                                        ...
                                        <button type="submit" class="p-2 bg-red-50 text-red-600 rounded-xl hover:bg-red-600 hover:text-white transition-all shadow-sm border border-red-100 btn-hapus" 
                                                data-name="{{ $pengeluaran->deskripsi }}" title="Batalkan Transaksi">
    ...
    <div x-show="modalOpen" 
        ...
        <div class="bg-white rounded-[2.5rem] shadow-2xl w-full relative z-10 overflow-hidden border border-slate-100"
            ...
            <template x-if="modalType === 'tambah'">
                <form action="{{ route('pengeluaran.store') }}" method="POST" enctype="multipart/form-data" id="pengeluaranForm">
                    @csrf
