                    ...
                    <table class="w-full text-left">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors group">
                                ...
                                <td class="px-8 py-5">
                                    <p class="text-xs font-bold text-slate-600 leading-relaxed tracking-tight group-hover:text-slate-900 transition-colors uppercase italic">{{ $q->question_autis->question_text ?? 'Pertanyaan tidak ditemukan / dihapus' }}</p>
                                </td>
