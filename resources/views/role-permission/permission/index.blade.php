        ...
        <div class="lg:col-span-8">
            <div class="card-premium overflow-hidden bg-white shadow-xl shadow-slate-200/50">
                <div class="p-6 border-b border-slate-50 flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white">
                    ...
                    <form action="{{ route('permissions.index') }}" method="GET" class="flex items-center gap-2">
                        <div class="relative">
                        ...
                        @if(request('search'))
                        <a href="{{ route('permissions.index') }}" class="p-2 bg-slate-100 text-slate-500 rounded-xl hover:bg-slate-200 transition-all">
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors group">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2 transition-opacity">
                                        ...
                                        <button @click='openEdit({{ $permission->id }}, {{ json_encode($permission->name, JSON_HEX_APOS) }})' 
