    ...
    <div class="card-premium overflow-hidden">
        <div class="p-6 border-b border-slate-50 flex flex-col md:flex-row md:items-center justify-between bg-white gap-4">
            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                <form action="{{ route('keuangan.pemasukkan') }}" method="GET" class="relative w-full md:w-64">
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari transaksi..." class="w-full bg-slate-50 border-slate-100 rounded-xl pl-10 pr-4 py-2 text-xs font-bold focus:ring-2 focus:ring-emerald-50 focus:border-emerald-200 transition-all outline-none text-slate-600">
                    <i data-lucide="search" class="w-4 h-4 text-slate-400 absolute left-3 top-1/2 -translate-y-1/2"></i>
                </form>
                <span class="hidden md:inline-block px-3 py-1 bg-slate-50 text-slate-400 border border-slate-100 rounded-lg text-[9px] font-black uppercase tracking-widest italic">Real-time Sync</span>
            </div>
        </div>
