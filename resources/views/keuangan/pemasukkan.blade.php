            ...
            <div class="flex items-center gap-3 w-full md:w-auto">
                <form action="{{ route('keuangan.pemasukkan') }}" method="GET" class="flex w-full md:w-auto gap-2">
                    <div class="relative w-full md:w-64 flex-1">
                        <input type="search" name="search" value="{{ request('search') }}" placeholder="Cari transaksi..." class="w-full bg-slate-50 border border-slate-100 rounded-xl pl-10 pr-4 py-2 text-xs font-bold focus:ring-2 focus:ring-emerald-50 focus:border-emerald-200 transition-all outline-none text-slate-600">
