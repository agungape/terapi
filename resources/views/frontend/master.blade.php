...
<head>
    ...
    <!-- Favicon Icon -->
    <link rel="icon" href="{{ asset('assets') }}/website/img/favicon.png" />
    <!-- Stylesheets -->
    ...
    <link rel="stylesheet" href="{{ asset('assets') }}/website/css/lightgallery.min.css" />
    <link rel="stylesheet" href="{{ asset('assets') }}/website/css/animate.css" />
    <link rel="stylesheet" href="{{ asset('assets') }}/website/css/jQueryUi.min.css" />
    <link rel="stylesheet" href="{{ asset('assets') }}/website/css/textRotate.css" />
...
<body>
                ...
                <div class="st-main-header-in">
                    <div class="st-main-header-left">
                        <a class="st-site-branding" href="index.html"><img
                                src="{{ asset('assets') }}/website/img/logo.png" alt="Nischinto"></a>
                    </div>
                    <div class="st-main-header-right">
                        <div class="st-nav">
                            <ul class="st-nav-list st-onepage-nav">
                                ...
                                <li><a href="#department" class="st-smooth-move">Program Terapi</a></li>
                                <li><a href="#doctors" class="st-smooth-move">Terapis</a></li>
                                <li><a href="#gallery" class="st-smooth-move">Gallery</a></li>
                                <li><a href="#career" class="st-smooth-move">Career</a></li>
    ...
    <div class="st-content">
        ...
        <div class="st-hero-wrap st-gray-bg overflow-hidden">
            <div class="st-hero st-style1">
                <div class="container">
                    <div class="st-hero-text">
                        ...
                        <div class="st-hero-subtitle">The art of medicine consists in amusing the patient while. <br>
                            Treatment without prevention is simply.</div>
                    ...
                    <div class="slick-wrapper">
                        <div class="slick-slide-in">
                            <div class="st-hero-img">
                                <img src="{{ asset('assets') }}/website/img/hero-bg1.jpg" alt="Hero img">
                            </div>
                        </div>
                        <div class="slick-slide-in">
                            <div class="st-hero-img">
                                <img src="{{ asset('assets') }}/website/img/hero-bg6.jpg" alt="Hero img">
                            </div>
                        </div>
                        <div class="slick-slide-in">
                            <div class="st-hero-img">
                                <img src="{{ asset('assets') }}/website/img/hero-bg13.jpg" alt="Hero img">
                            </div>
                        </div>
                    </div>
                </div><!-- .slick-container -->
            ...
            <div class="st-hero-shape st-style1"><img src="{{ asset('assets') }}/website/img/shape/hero-shape2.png"
                    alt="hero shape"></div>
        </div>
        <!-- End Hero Seciton -->
        ...
        <section class="st-about-wrap" id="about">
            <div class="st-shape-bg">
                <img src="{{ asset('assets') }}/website/img/shape/about-bg-shape.svg" alt="shape">
            </div>
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    ...
                    <div class="st-seperator">
                        ...
                        <div class="st-seperator-center"><img src="{{ asset('assets') }}/website/img/icons/4.png"
                                alt="icon"></div>
                            ...
                            <div class="st-vertical-middle-in">
                                <div class="st-text-block st-style1">
                                    <h2 class="st-text-block-title">A hospital is a health care institution providing
                                        patient treatment with specialized medical</h2>
                                    ...
                                    <div class="st-text-block-text">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                            ...
                                            quis nostrud exercitation ullamc laboris nisi ut aliquip. Commodo consequat.
                                        </p>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
                                            tempor incidid unt labore et dolore magna aliqua. Ut enim ad minim veniam,
                                            quis nostrud exercitation ullamc laboris nisi ut aliquip. Commodo consequat.
                                            Sed do eiusmod tempor incidid unt labore et dolore magna aliqua.</p>
                                    </div>
                                    <div class="st-height-b25 st-height-lg-b25"></div>
                                    <div class="st-text-block-avatar">
                                        <div class="st-avatar-img"><img
                                                src="{{ asset('assets') }}/website/img/avatar1.png" alt="avatar">
                                        </div>
                                        <div class="st-avatar-info">
                                            <h4 class="st-avatar-name">{{ $profile->ketua }}</h4>
                                            <div class="st-avatar-designation">Ketua Yayasan</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-5 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="st-shedule-wrap">
                            <div class="st-shedule">
                                <h2 class="st-shedule-title">Waktu Operasional</h2>
                                <ul class="st-shedule-list">
                                    <li>
                                        <div class="st-shedule-left">Senin</div>
                                        <div class="st-shedule-right">09:00 – 17:00 </div>
                                    </li>
                                    <li>
                      ...
                      c8.481,0,15.354-6.875,15.356-15.354C356.215,211.732,348.444,192.968,333.737,178.26z" />
                                    ...
                                    <div class="st-call-text">
                                        ...
                                        <div class="st-call-number">{{ $profile->telepon }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section id="department">
            ...
            <div class="container">
                <div class="st-section-heading st-style1">
                    <h2 class="st-section-heading-title">Program Terapi</h2>
                    <div class="st-seperator">
                        <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s">
                        </div>
                        <div class="st-seperator-center"><img src="{{ asset('assets') }}/website/img/icons/4.png"
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="st-imagebox-img"><img
                                                src="{{ asset('assets') }}/website/img/crutches.png" alt="service">
                                        </div>
                                        <div class="st-height-b0 st-height-lg-b30"></div>
                                    </div>
                                    <div class="col-lg-6">
                                            ...
                                            <div class="st-vertical-middle-in">
                                                <div class="st-imagebox-info">
                                                    ...
                                                    <div class="st-imagebox-text">Oillum abrem deleniti adipisci
                                                        suscipit dignissimos. remaining essentially unchanged. It was
                                                        popularised in the with the . Lorem Ipsum is simply dummy text
                                                ...
                                                <div class="st-imagebox-btn">
                                                    <a href="#"
                                                        class="st-btn st-style1 st-size-medium st-color1">Read More</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="X-ray" class="st-tab">
                            <div class="st-imagebox st-style2">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="st-imagebox-img"><img
                                                src="{{ asset('assets') }}/website/img/xray.png" alt="service">
                                        </div>
                                        <div class="st-height-b0 st-height-lg-b30"></div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="st-vertical-middle">
                                            <div class="st-vertical-middle-in">
                                                <div class="st-imagebox-info">
                                                    <h2 class="st-imagebox-title">Welcome to our <span>X-ray</span>
                                                    </h2>
                                                    <h4 class="st-imagebox-subtitle">Lorem ipsum dolor sit amet,
                                                        consectetur adipisicing elit. Magni nemo libero debitis vitae
                                                        sapiente quos. </h4>
                        ...
                        <div id="Pulmonary" class="st-tab">
                            <div class="st-imagebox st-style2">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="st-imagebox-img"><img
                                                src="{{ asset('assets') }}/website/img/pulmonary.png" alt="service">
                                        </div>
                                        <div class="st-height-b0 st-height-lg-b30"></div>
                                    </div>
                                    <div class="col-lg-6">
                        ...
                        <div id="Cardiology" class="st-tab">
                            <div class="st-imagebox st-style2">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="st-imagebox-img"><img
                                                src="{{ asset('assets') }}/website/img/cardiology.png"
                                                alt="service">
                                        </div>
                                        <div class="st-height-b0 st-height-lg-b30"></div>
                                    </div>
                        ...
                        <div id="DentalCare" class="st-tab">
                            <div class="st-imagebox st-style2">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="st-imagebox-img"><img
                                                src="{{ asset('assets') }}/website/img/dental-care.png"
                                                alt="service"></div>
                                        <div class="st-height-b0 st-height-lg-b30"></div>
                                    </div>
                                    <div class="col-lg-6">
                        ...
                        <div id="Neurology" class="st-tab">
                            <div class="st-imagebox st-style2">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="st-imagebox-img"><img
                                                src="{{ asset('assets') }}/website/img/neurology.png" alt="service">
                                        </div>
                                        <div class="st-height-b0 st-height-lg-b30"></div>
                                    </div>
                                    <div class="col-lg-6">
        ...
        <section id="appointment" class="st-shape-wrap st-gray-bg">
            <div class="st-shape4">
                <img src="{{ asset('assets') }}/website/img/shape/section_shape.png" alt="shape1">
            </div>
            <div class="st-shape6">
                <img src="{{ asset('assets') }}/website/img/shape/contact-shape3.svg" alt="shape3">
            </div>
            <div class="st-height-b120 st-height-lg-b80"></div>
            <div class="container">
                <div class="st-section-heading st-style1">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <form method="POST" action="{{ asset('assets') }}/website/php/appointment.php"
                    ...
                    <div class="slick-container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0"
                        ...
                        <div class="slick-wrapper">
                            <div class="slick-slide-in">
                                <div class="st-member st-style1 st-zoom">
                                    <div class="st-member-img">
                                        <img src="{{ asset('assets') }}/website/img/member1.jpg" alt=""
                                            class="st-zoom-in">
                                        <a class="st-doctor-link" href="doctor-profile.html"><i
                                                class="fas fa-link"></i></a>
                                        <div class="st-member-social-wrap">
                                            <img src="{{ asset('assets') }}/website/img/shape/member-shape.svg"
                            ...
                            <div class="slick-slide-in">
                                <div class="st-member st-style1 st-zoom">
                                    <div class="st-member-img">
                                        <img src="{{ asset('assets') }}/website/img/member2.jpg" alt="member2"
                                            class="st-zoom-in">
                                        <a class="st-doctor-link" href="doctor-profile.html"><i
                                                class="fas fa-link"></i></a>
                                        <div class="st-member-social-wrap">
                            ...
                            <div class="slick-slide-in">
                                <div class="st-member st-style1 st-zoom">
                                    <div class="st-member-img">
                                        <img src="{{ asset('assets') }}/website/img/member3.jpg" alt="member3"
                                            class="st-zoom-in">
                                        <a class="st-doctor-link" href="doctor-profile.html"><i
                                                class="fas fa-link"></i></a>
                                        <div class="st-member-social-wrap">
                            ...
                            <div class="slick-slide-in">
                                <div class="st-member st-style1 st-zoom">
                                    <div class="st-member-img">
                                        <img src="{{ asset('assets') }}/website/img/member4.jpg" alt="member4"
                                            class="st-zoom-in">
                                        <a class="st-doctor-link" href="doctor-profile.html"><i
                                                class="fas fa-link"></i></a>
                                        <div class="st-member-social-wrap">
                ...
                <div class="st-portfolio-wrapper">
                    ...
                    <div class="st-isotop st-style1 st-port-col-3 st-has-gutter st-lightgallery">
                        ...
                        <div class="st-isotop-item cardiology urology">
                            <a href="{{ asset('assets') }}/website/img/project1_lg.jpg"
                                class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img
                                        src="{{ asset('assets') }}/website/img/project1.jpg" alt="project1"></div>
                                <span class="st-link-hover"><i class="fas fa-arrows-alt"></i></span>
                            </a>
                        </div><!-- .st-isotop-item -->

                        <div class="st-isotop-item cardiology neurology">
                            <a href="{{ asset('assets') }}/website/img/project2_lg.jpg"
                                class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img
                                        src="{{ asset('assets') }}/website/img/project2.jpg" alt="project2"></div>
                                <span class="st-link-hover"><i class="fas fa-arrows-alt"></i></span>
                            </a>
                        </div><!-- .st-isotop-item -->

                        <div class="st-isotop-item urology pulmonary">
                            <a href="{{ asset('assets') }}/website/img/project3_lg.jpg"
                                class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img
                                        src="{{ asset('assets') }}/website/img/project3.jpg" alt="project3"></div>
                                <span class="st-link-hover"><i class="fas fa-arrows-alt"></i></span>
                            </a>
                        </div><!-- .st-isotop-item -->

                        <div class="st-isotop-item neurology traumatology">
                            <a href="{{ asset('assets') }}/website/img/project4_lg.jpg"
                                class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img
                                        src="{{ asset('assets') }}/website/img/project4.jpg" alt="project4"></div>
                                <span class="st-link-hover"><i class="fas fa-arrows-alt"></i></span>
                            </a>
                        </div><!-- .st-isotop-item -->

                        <div class="st-isotop-item cardiology pulmonary">
                            <a href="{{ asset('assets') }}/website/img/project5_lg.jpg"
                                class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img
                                        src="{{ asset('assets') }}/website/img/project5.jpg" alt="project5"></div>
                                <span class="st-link-hover"><i class="fas fa-arrows-alt"></i></span>
                            </a>
                        </div><!-- .st-isotop-item -->

                        <div class="st-isotop-item neurology traumatology">
                            <a href="{{ asset('assets') }}/website/img/project6_lg.jpg"
                                class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img
                                        src="{{ asset('assets') }}/website/img/project6.jpg" alt="project6"></div>
                                <span class="st-link-hover"><i class="fas fa-arrows-alt"></i></span>
                            </a>
                        </div><!-- .st-isotop-item -->

                        <div class="st-isotop-item urology pulmonary traumatology">
                            <a href="{{ asset('assets') }}/website/img/project7_lg.jpg"
                                class="st-project st-zoom st-lightbox-item st-link-hover-wrap">
                                <div class="st-project-img st-zoom-in"><img
                                        src="{{ asset('assets') }}/website/img/project7.jpg" alt="project6"></div>
                                <span class="st-link-hover"><i class="fas fa-arrows-alt"></i></span>
                            </a>
                        </div><!-- .st-isotop-item -->
                    </div><!-- .isotop -->
        ...
        <!-- Start Before After -->
        <section class="st-before-after-section st-dynamic-bg st-bg"
            data-src="{{ asset('assets') }}/website/img/before-after-bg.jpg">
            <div class="st-height-b120 st-height-lg-b80"></div>
            <div class="container">
                <div class="st-section-heading st-style1">
                ...
                <div class="container">
                    <div class="st-before-after-in">
                        <div class="st-before-after">
                            <div class="st-after st-single-slide st-dynamic-bg"
                                data-src="{{ asset('assets') }}/website/img/after.jpg"></div>
                            <div class="st-before st-single-slide st-dynamic-bg"
                                data-src="{{ asset('assets') }}/website/img/before.jpg"></div>
                        ...
                        <div class="slick-wrapper">
                                ...
                                <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s"
                                    ...
                                    <div class="st-testimonial-info">
                                        <div class="st-testimonial-img"><img
                                                src="{{ asset('assets') }}/website/img/avatar2.png" alt="avatar1">
                                        </div>
                                    ...
                                    <div class="st-testimonial-text">Lorem Ipsum is simply dummy text of the printing
                                        and typesetting industry. Lorem Ipsum the industry's standard dummy text.</div>
                            ...
                            <div class="slick-slide-in">
                                <div class="st-testimonial st-style1">
                                    <div class="st-testimonial-info">
                                        <div class="st-testimonial-img"><img
                                                src="{{ asset('assets') }}/website/img/avatar3.png" alt="avatar2">
                                        </div>
                                        <div class="st-testimonial-meta">
                            ...
                            <div class="slick-slide-in">
                                <div class="st-testimonial st-style1 wow fadeInRight" data-wow-duration="0.8s"
                                    ...
                                    <div class="st-testimonial-info">
                                        <div class="st-testimonial-img"><img
                                                src="{{ asset('assets') }}/website/img/avatar4.png" alt="avatar3">
                                        </div>
                                        <div class="st-testimonial-meta">
                                ...
                                <div class="st-funfact st-style1">
                                    <div class="st-funfact-icon st-dip-blue-box">
                                        <svg enable-background="new 0 0 511.619 511.619"
                                            viewBox="0 0 511.619 511.619" xmlns="http://www.w3.org/2000/svg">
                                            <g>
                                                <path
                    ...
                    <div class="col-xl-6 wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">
                        <div class="st-video-block st-style1 st-zoom">
                            <div class="st-video-block-img st-zoom-in st-dynamic-bg"
                                data-src="{{ asset('assets') }}/website/img/video-block-img.jpg"></div>
        ...
        <section class="st-faq-wrap st-shape-wrap">
            <div class="st-shape5">
                <img src="{{ asset('assets') }}/website/img/shape/faq-bg.svg" alt="shape1">
            </div>
            <div class="st-height-b120 st-height-lg-b80"></div>
            <div class="container">
                <div class="row">
                        ...
                        <div class="st-vertical-middle">
                            <div class="st-vertical-middle-in">
                                <div class="st-faq-img">
                                    <img src="{{ asset('assets') }}/website/img/faq-img.png" alt="Faq Image">
                                </div>
                            </div>
                        </div>
                        <div class="st-height-b0 st-height-lg-b30"></div>
                        ...
                        <div class="slick-wrapper">
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-orange-box">
                                    <img src="{{ asset('assets') }}/website/img/client1.png" alt="client1">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-blue-box">
                                    <img src="{{ asset('assets') }}/website/img/client2.png" alt="client2">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-red-box">
                                    <img src="{{ asset('assets') }}/website/img/client3.png" alt="client3">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-green-box">
                                    <img src="{{ asset('assets') }}/website/img/client4.png" alt="client4">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-dip-blue-box">
                                    <img src="{{ asset('assets') }}/website/img/client5.png" alt="client5">
                                </div>
                            </div><!-- .slick-slide-in -->
                            <div class="slick-slide-in">
                                <div class="st-logo-carousel st-style1 st-orange-box">
        ...
        <section class="st-shape-wrap" id="career">
            <div class="st-shape1"><img src="{{ asset('assets') }}/website/img/shape/contact-shape1.svg"
                    alt="shape1"></div>
            <div class="st-shape2"><img src="{{ asset('assets') }}/website/img/shape/contact-shape2.svg"
                    alt="shape2"></div>
            <div class="st-height-b120 st-height-lg-b80"></div>
            <div class="container">
                <div class="st-section-heading st-style1">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div id="st-alert"></div>
                        <form action="{{ asset('assets') }}/website/php/mail.php"
    ...
    <footer class="st-site-footer st-sticky-footer st-dynamic-bg"
        data-src="{{ asset('assets') }}/website/img/footer-bg.png">
                    ...
                    <div class="col-lg-3">
                        <div class="st-footer-widget">
                            <div class="st-text-field">
                                <img src="{{ asset('assets') }}/website/img/footer-logo.png" alt="Nischinto"
            ...
            <div class="container">
                <div class="st-copyright-in">
                    <div class="st-left-copyright">
                        <div class="st-copyright-text">Copyright 2024. {{ $profile->nama }}</div>
                    </div>
    ...
    <script src="{{ asset('assets') }}/website/js/isotope.pkg.min.js"></script>
    <script src="{{ asset('assets') }}/website/js/jquery.slick.min.js"></script>
    <script src="{{ asset('assets') }}/website/js/mailchimp.min.js"></script>
    <script src="{{ asset('assets') }}/website/js/counter.min.js"></script>
    <script src="{{ asset('assets') }}/website/js/lightgallery.min.js"></script>
    <script src="{{ asset('assets') }}/website/js/ripples.min.js"></script>
    <script src="{{ asset('assets') }}/website/js/wow.min.js"></script>
    <script src="{{ asset('assets') }}/website/js/jQueryUi.js"></script>
    <script src="{{ asset('assets') }}/website/js/textRotate.min.js"></script>
