    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Data Login Anak</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item active">Data Login Anak</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                    ...
                                    <tbody>
                                        ...
                                        @forelse ($users as  $user)
                                            <tr>
                                                ...
                                                <td>
                                                    <form
                                                        action="{{ route('useranak.destroy', ['useranak' => $user->id]) }}"
    ...
    <div class="modal fade" id="tambahModal" tabindex="-1" aria-labelledby="tambahModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('useranak.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group row mb-3">
                            <label for="validationCustom04" class="col-sm-4 col-form-label">Role</label>
                            <div class="col-sm-8">
                                <input id="role" type="text" class="form-control" name="role"
                                    value="{{ 'Anak' }}" readonly required>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="editUserForm" action="{{ route('useranak.update', ':id') }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="modal-body">
                        <div class="form-group row mb-3">
...
@section('scripts')
    <script>
        ...
        $('#editModal').on('show.bs.modal', function(event) {
            ...
            // Update action form
            var actionUrl = "{{ route('useranak.update', ':id') }}".replace(':id', id);
