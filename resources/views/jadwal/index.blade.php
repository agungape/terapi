                                ...
                                <form action="{{ route('jadwal.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group row mb-3">
                                            <label for="anak_id" class="col-sm-4 col-form-label">Anak</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label for="terapis_id" class="col-sm-4 col-form-label">Terapis</label>
                                            <div class="col-sm-8">
                                                <select
                                        ...
                                        <div class="form-group row mb-3">
                                            <label for="waktu" class="col-sm-4 col-form-label">Waktu (*wita)</label>
                                            <div class="col-sm-8">
                                                <select name="waktu"
                                    ...
                                    <div class="modal-footer">
                                        @can('create jadwal anak')
                                            <button type="submit" class="btn btn-success btn-sm">Buat Jadwal</button>
                                        @endcan
                                    </div>
                                </form>
                            </div>
                                        ...
                                        @forelse($jadwals as $jadwal)
                                            <tr>
                                                ...
                                                <td class="text-center"><span
                                                        class="badge bg-primary">{{ $jadwal->anak->nama }}</span></td>
